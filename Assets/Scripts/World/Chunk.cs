...
namespace World
{
    ...
    public class Chunk : MonoBehaviour, IPoolable
    {
        ...
        public const int ElementsInVoxel = 2;
        public const int VoxelElementSize = sizeof(uint);
        ...
        private void CreateBuffers()
        {
            if (m_voxelVolumeBuffer?.count != WorldManager.VoxelConfig.VoxelVolumeConfig.VoxelCount)
            {
                ...
                m_voxelVolumeBuffer = new ComputeBuffer(WorldManager.VoxelConfig.VoxelVolumeConfig.VoxelCount, VoxelElementSize * ElementsInVoxel);
            }
        }
        ...
        public ComputeBuffer GetVoxelsBuffer()
        {
            return m_voxelVolumeBuffer;
        }
    }
}